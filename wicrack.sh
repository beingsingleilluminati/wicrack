...
general_exitmode_8="Thanks for using wicrack"
#############################################################################################
...
function top(){
        ...
        echo -e "$red[~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~]"
        echo -e "$red[                                                      ]"
        echo -e "$red[  $red WICRACK $version" "${yellow} ${red} < WI""${yellow}CRACK" "${red}O""${yellow}n" "${red}T""${yellow}he""${red}N""${yellow}etwork >  "       ${blue}"           ]"
        echo -e "$blue[                                                      ]"
...
if [ $FLUX_DEBUG != 1 ]; then
        ...
        sleep 0.1
        echo -e $red"                        WICRACK "$white" "$yellow"by "$white" SuryaS"
        sleep 0.1
        echo -e $green "                  "$red" This is Made by LONELY Hacker "$transparent
        sleep 0.1
        echo -n "                          Latest rev."
        tput civis
        checkupdatess &
...
if [ "$FLUX_AUTO" =  "1" ];then
        ...
        while true; do
                ...
                echo "                                       "
                echo -n -e ""$red"["$blue"wicrack"$yellow"@"$white"suryas"$red"]-["$yellow"~"$red"]"$transparent""
                read yn
                echo ""
                case $yn in
